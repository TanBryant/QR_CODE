      ...
      <table className="rounded-[3px] w-full">
        <thead>
          <tr className="border-b-[1px] border-[#ccc]">
            <th className="text-[16px] font-bold text-[#000]">ID</th>
            <th className="text-[16px] font-bold text-[#000]">Tên</th>
            ...
            <th className="text-[16px] font-bold text-[#000]">Trạng thái</th>
            <th className="text-[16px] font-bold text-[#000]">Chức năng</th>
          </tr>
        </thead>
        <tbody>
          {campaigns?.map((item) => (
            ...
            >
              ...
              <td className="text-[16px]">{item?.status?.name}</td>
